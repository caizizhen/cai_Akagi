...
const LG_LAYOUT: LayoutItem[] = [
  { i: 'header',          x: 0, y: 0,  w: 12, h: 2, minW: 6, minH: 2, maxH: 4 },
  ...
  { i: 'self-hand',       x: 0, y: 16, w: 12, h: 3, minW: 6, minH: 2, maxH: 4 },
...
const MD_LAYOUT: LayoutItem[] = [
  { i: 'header',          x: 0, y: 0,  w: 10, h: 2, minW: 5, minH: 2, maxH: 4 },
  { i: 'player-0',        x: 0, y: 2,  w: 3,  h: 8, minW: 2, minH: 6 },
  { i: 'player-1',        x: 3, y: 2,  w: 3,  h: 8, minW: 2, minH: 6 },
  ...
  { i: 'self-hand',       x: 0, y: 22, w: 10, h: 3, minW: 5, minH: 2, maxH: 4 },
...
const SM_LAYOUT: LayoutItem[] = [
  { i: 'header',          x: 0, y: 0,  w: 6, h: 2, minW: 4, minH: 2, maxH: 4 },
  { i: 'player-0',        x: 0, y: 2,  w: 3, h: 8, minW: 2, minH: 6 },
  { i: 'player-1',        x: 3, y: 2,  w: 3, h: 8, minW: 2, minH: 6 },
  ...
  { i: 'self-hand',       x: 0, y: 30, w: 6, h: 3, minW: 4, minH: 2, maxH: 4 },
